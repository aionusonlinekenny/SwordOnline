...
public:
	BOOL B_QueryChannelID(const std::_tstring& channel, DWORD ip, unsigned long param, DWORD nameid, DWORD serverip);
...
public:
	...
	BOOL SayOnChannel(DWORD channid, const std::_tstring& name, const std::_tstring& sent);
...
private:
	BOOL Block_QueryChannelID(const std::_tstring& channel, DWORD ip, unsigned long param, DWORD nameid, DWORD serverip);
