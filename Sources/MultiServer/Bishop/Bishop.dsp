...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\Common" /I "..\Rainbow\Interface" /I "..\Heaven\Interface" /I "..\..\..\lib" /I "..\..\..\Headers" /I "..\..\Sword3PaySys\S3AccServer" /I "..\..\s3client\login" /I "..\..\RoleDBManager" /I "..\..\Core\src" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /FR /Yu"stdafx.h" /FD /c
...
SOURCE="$(InputPath)"
PostBuild_Cmds=md ..\..\..\..\bin\server\	copy release\Bishop.exe ..\..\..\..\bin\server\Bishop.exe	md ..\..\..\..\bin\server\release\	copy release\Bishop.exe ..\..\..\..\bin\server\release\Bishop.exe
